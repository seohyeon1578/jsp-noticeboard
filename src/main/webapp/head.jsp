...
<script type="text/javascript">
    ...
    const render = () => {
        document.addEventListener('click', (event) => {
            const isClickIn = btn.contains(event.target);
