...
<header>
    ...
    <button class="btn" onclick="location.href='login.jsp'">
        <div class="profile-svg">
            <svg data-bbox="0 0 50 50" data-type="shape" xmlns="http://www.w3.org/2000/svg" width="30   " height="30"
                 viewBox="0 0 50 50">
                <g>
        ...
        <button class="btn">
            <div class="profile-svg">
                <svg data-bbox="0 0 50 50" data-type="shape" xmlns="http://www.w3.org/2000/svg" width="30   "
